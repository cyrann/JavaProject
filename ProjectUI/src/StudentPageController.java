...
//        Student student = new Student(id, first, last, dob, gender, program);
        insert(id, first, last, dob, gender, program, reason);
    ...
    public void insert(String id, String first, String last, LocalDate dob, String gender, String program, String reason){
